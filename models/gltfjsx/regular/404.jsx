...
Command: npx gltfjsx@6.5.3 models/glb/regular/404.glb -o models/gltfjsx/regular/404.jsx 
...
export default function Model(props) {
  ...
  const { scene, animations } = useGLTF('https://raw.githubusercontent.com/Sudhanshu-Ambastha/Pokemon-3D/main/models/glb/regular/404.glb')
        ...
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              <group name="Armature_88" rotation={[Math.PI / 2, 0, 0]} scale={3.208}>
                <group name="GLTF_created_0">
                  <primitive object={nodes.GLTF_created_0_rootJoint} />
                  <group name="Object_0_81" />
                  <group name="Object_1_82" />
                  <group name="Object_2_83" />
                  <group name="Object_3_84" />
                  <group name="Object_4_85" />
                  <group name="Object_5_86" />
                  <group name="Object_6_87" />
                  <skinnedMesh name="Object_7" geometry={nodes.Object_7.geometry} material={materials.material} skeleton={nodes.Object_7.skeleton} />
                  <skinnedMesh name="Object_9" geometry={nodes.Object_9.geometry} material={materials.Mouth} skeleton={nodes.Object_9.skeleton} />
...
useGLTF.preload('https://raw.githubusercontent.com/Sudhanshu-Ambastha/Pokemon-3D/main/models/glb/regular/404.glb')
