...
Command: npx gltfjsx@6.5.3 models/glb/regular/4.glb -o models/gltfjsx/regular/4.jsx 
*/
...
export default function Model(props) {
  const { scene } = useGLTF('https://raw.githubusercontent.com/Sudhanshu-Ambastha/Pokemon-3D/main/models/glb/regular/4.glb')
  const clone = React.useMemo(() => SkeletonUtils.clone(scene), [scene])
  const { nodes, materials } = useGraph(clone)
  return (
    <group {...props} dispose={null}>
      <group scale={2.54}>
        <group position={[0, 0.214, -0.015]} rotation={[0, 0, Math.PI / 2]}>
